    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0F1117] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#E8E8F0] mb-2">Welcome back</h1>
          <p className="text-[#8B8FA8]">Your journey continues today.</p>
        </div>
        ...
        <p className="text-center text-[#8B8FA8] text-sm mt-6">
          ...
          <Link to="/signup" className="text-[#C17A47] hover:text-[#E8955A] font-semibold transition-colors">
            Create one
          </Link>
        </p>
      </div>
